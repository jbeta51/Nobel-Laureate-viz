...
var colors = {}
colors["peace"] = "red";
colors["economics"] = "blue";
colors["chemistry"] = "orange";
colors["literature"] = "green";
colors["physics"] = "purple";
colors["medicine"] = "teal";
			...
			females.on("mouseover", function(d) {		
				...
				div	.html("<h1>" + (d.fullname) + "</h1> <br/>" +
						  "<img width='128' style='opacity:1' src=" + imgPath + " /img> <br/>" +
							"<h2 id='category'>" + (d.category) + "</h2> <br/>" +
							"<p>" + (d.motivation) + "</p>")

					.style("left", (d3.event.pageX) + "px")		
					.style("top", (d3.event.pageY - 28) + "px");
					document.getElementById("category").style.color = colors[d.category];
			})
